...
def test_gru_tosa_FP():
    ...
    pipeline.add_stage_after(
        ...
        RunPasses(pass_manager_cls=None, pass_list=[DecomposeGruPass]),
        suffix="decompose_gru",
    )
...
class TestGRUBidirectional:
    """Tests bidirectional torch.nn.GRU via the DecomposeGruPass."""

    gru = torch.nn.GRU(10, 20, 2, bidirectional=True).eval()
    model_example_inputs = get_bidi_test_inputs()


def test_gru_bidirectional_tosa_FP():
    pipeline = TosaPipelineFP[input_t](
        TestGRUBidirectional.gru,
        TestGRUBidirectional.model_example_inputs,
        aten_op=[],
        exir_op=[],
        use_to_edge_transform_and_lower=True,
    )
...
def test_gru_bidirectional_tosa_INT():
    pipeline = TosaPipelineINT[input_t](
        TestGRUBidirectional.gru,
        TestGRUBidirectional.model_example_inputs,
        aten_op=[],
...
@common.XfailIfNoCorstone300
def test_gru_bidirectional_u55_INT():
    pipeline = EthosU55PipelineINT[input_t](
        TestGRUBidirectional.gru,
        TestGRUBidirectional.model_example_inputs,
        aten_ops=[],
...
@common.XfailIfNoCorstone320
def test_gru_bidirectional_u85_INT():
    pipeline = EthosU85PipelineINT[input_t](
        TestGRUBidirectional.gru,
        TestGRUBidirectional.model_example_inputs,
        aten_ops=[],
